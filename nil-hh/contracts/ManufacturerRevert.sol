...
contract ManufacturerRevert is NilBase {
    ...
    function createProduct(
        ...
        if (msg.sender == retailerContractAddress) {
            if (keccak256(abi.encodePacked(productName)) == keccak256(abi.encodePacked("revert"))) {
                revert("ManufacturerRevert: This should revert");
            }
